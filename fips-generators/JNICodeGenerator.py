...
Version = 1
HeaderNote = '// Machine generated by fips-jni. Do not edit!\n// #version:{}#\n\n'.format(Version)
...
def generate(input, out_src, out_hdr) :
    ...
    # collect dependencies for dirty check
    deps = [input]
    for header in desc['headers'] :
        deps.append(os.path.join(header_path, header['source']))

    if util.isDirty(Version, deps, [out_src, out_hdr]) :
        ...
        for header in desc['headers'] :
            ...
            ast = parse_file(header_file, use_cpp=True, cpp_path=parser_cpp, cpp_args=parser_args)
